...
@WebServlet("/UpdateMenuItemView")
public class UpdateMenuItemView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (menuItemList != null) {
			...
			request.getRequestDispatcher("/menuItem_jsp/updateMenuItem.jsp").forward(request, response);
		} else {
