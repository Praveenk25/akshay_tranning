...
@WebServlet("/p/ListOfMenuItemView")
public class ListOfMenuItemView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (menuItemList != null) {
			...
			request.getRequestDispatcher("/menuItem_jsp/viewMenuItem.jsp").forward(request, response);
		} else {
